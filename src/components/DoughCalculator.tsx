...
export const PIZZA_PRESETS: PizzaPreset[] = [
  ...
  },
  {
    ...
    portionType: 'ball', portionLabel: 'ball', portionLabelPlural: 'balls',
    yeastType: 'dry',
    minOvenTemp: 230, minWStrength: 250,
    timings: {
  ...
  },
  {
    ...
    shortName: 'Canotto',
    badge: 'CANOTTO',
    description: 'The modern "lifeboat" style from Stadler Made. Enormous alveolated rim (canotto = inflatable boat). Direct method: 70% hydration, cold-fermented dough with strong flour.',
    hydration: 70,
    saltPercent: 2.5,
    yeastPercent: 0.14,
    oilPercent: 0,
    ...
    timings: {
      bulkRT: '2 hours @ 20°C',
      bulkCold: '24–48 hours @ 4–6°C',
      ballRT: '2–3 hours @ room temp',
      ballCold: '0 hours',
      bakeTemp: '380°C – 400°C (wood-fired / Effeuno)',
      bakeTime: '3 minutes',
    ...
    steps: [
      'Add yeast and half the flour to water. Mix until a shaggy dough forms. Gradually add remaining {FLOUR} ({W}) while kneading.',
      'Add salt and continue kneading. For 70% hydration use autolysis: mix flour + 80% of water, rest 30 min, then add salt + remaining water and knead until smooth.',
      'Perform stretch-and-fold sets to build gluten strength — wet doughs gain structure through folds, not just kneading.',
      'Leave covered at 20°C for 2 hours. Yeast activates and dough relaxes.',
      'Transfer to sealed container. Cold ferment in fridge (4–6°C) for 24–48 hours. Aroma develops.',
      'Remove from fridge. Divide into 250g balls. Tension tightly from underneath to seal. Place in oiled containers.',
      'Proof at room temp for 2–3 hours until balls are pillowy and relaxed.',
      'Lift ball out with a spatula — do NOT touch the rim. Press air from center toward edges with fingertips. Never flatten the outer 2cm. Bake at 380–400°C for 3 min.',
    ],
  },
  {
    id: 'tokyo',
    ...
    shortName: 'Tokyo',
    badge: 'TOKYO',
    description: 'Japanese-Neapolitan fusion from stadlermade.com. Charred Neapolitan base with white cream-cheese sauce, mozzarella, salmon, wakame, edamame, and chili oil. 36-hour cold ferment on strong flour.',
    hydration: 68,
    saltPercent: 2.5,
    yeastPercent: 0.3,
    oilPercent: 0,
    ...
    portionType: 'ball', portionLabel: 'ball', portionLabelPlural: 'balls',
    yeastType: 'dry',
    minOvenTemp: 220, minWStrength: 280,
    timings: {
      bulkRT: '1 hour @ 18–22°C',
      bulkCold: '33 hours @ 4°C',
      ballRT: '2 hours @ 18–22°C',
      ballCold: '0 hours',
      bakeTemp: '450°C – 500°C (wood-fired / Effeuno)',
      bakeTime: '90 seconds – 3 minutes',
      bakeTempHome: '220–270°C — Baking Steel or stone, top rack, 45 min preheat. Broiler last 1–2 min for colour.',
      bakeTimeHome: '6–8 min',
      homeNote: 'Stadler Made has an official low-heat Tokyo recipe at 220–270°C. Same dough, longer bake on a baking steel. The white sauce, mozzarella, salmon and wakame toppings work beautifully even without leopard char.',
    },
    steps: [
      'Dissolve salt in all water. Add 1/3 of the {FLOUR} ({W}). Mix to a smooth batter. Add yeast and dissolve with fingers.',
      'Add remaining flour gradually. Knead 8–10 min in bowl until the dough comes together. Rest 10 min covered on the bench.',
      'Knead again 5–10 min until smooth and elastic. Shape into a ball. Rest 1 hour at room temp (18–22°C) covered.',
      'Divide into 220g balls. Seal airtight. Cold ferment in fridge (4°C) for 33 hours.',
      'Remove from fridge. Rest 2 hours at room temp (18–22°C) — gluten must relax fully before stretching.',
      'Preheat oven to max (450–500°C) at least 30 min. Mix 100g cream cheese + 25ml water to a spreadable white sauce.',
      'Stretch dough gently. Press a 2-knuckle-wide border around the edge to keep the crust airy. Do not flatten the rim.',
      'Spread white sauce, add mozzarella, wakame, edamame, and marinated salmon (teriyaki-glazed, cubed). Bake 90s–3 min. Finish with crispy chili oil.',
    ],
  },
  {
    id: 'newyork',
  ...
  },
  {
    ...
    timings: {
      bulkRT: '30 min at room temp',
      bulkCold: '40–70 hours @ 4°C',
      ballRT: '4 hours @ room temp (in oiled pan)',
      ballCold: '0 hours',
      bakeTemp: '300°C–320°C (outdoor oven / Effeuno) for fluffy inside',
      bakeTime: '8–10 minutes',
      bakeTempHome: '250°C (top+bottom heat + convection) for crunchier result',
      bakeTimeHome: '12–15 minutes',
      homeNote: 'At 250°C you get a crunchier, drier teglia. At 300°C+ the inside stays fluffy — both are valid results. Use a dark steel pan.',
    },
    steps: [
      'Dissolve fresh yeast in all cold water. Mix in 90% strong {FLOUR} ({W}) + 10% fine semolina one-quarter at a time, using a spatula.',
      'Add salt after the second quarter of flour. Continue adding remaining flour. When too stiff to stir, knead by hand until absorbed. Add olive oil and knead until smooth.',
      'Cover bowl and rest 10 min. Turn dough out onto a greased bench. Do 3 slap-and-fold sets, resting 10 min between each.',
      'Grease a container, place dough in, cover. Rest at room temp 30 min, then refrigerate at 4°C for 40–70 hours.',
      'Remove from fridge. Rest at room temp 1 hour. Cut dough into 400g pieces — each fills one 28×25 cm pan.',
      'Fold each piece: right side to middle, left side to middle, top to middle. Roll into a ball seam-down. Rest in oiled bowl 4 hours at room temp.',
      'Dust bench with semolina. Press dough flat with fingertips from outside toward center. Place in well-oiled pan. Lift edges to cover pan fully.',
      'Add toppings (rosemary, mozzarella, potato slices, pecorino, olive oil). Bake at 300°C for 8–10 min until golden (or 250°C for 12–15 min for crunchier result).',
    ],
  },
  {
    id: 'tonda',
    ...
    shortName: 'Tonda',
    badge: 'TONDA',
    description: 'Paper-thin, ultra-crisp Roman street pizza from Stadler Made. 60% hydration + 6% olive oil, rolled wafer-thin with a pin. 24–40h cold ferment + 6–8h room temp proof.',
    hydration: 60,
    saltPercent: 2.5,
    yeastPercent: 0.07,
    oilPercent: 6,
    ...
    timings: {
      bulkRT: '25 min resting on bench (no bulk ferment)',
      bulkCold: '24–40 hours @ 5°C',
      ballRT: '6–8 hours @ 20–22°C',
      ballCold: '0 hours',
      bakeTemp: '300°C – 360°C (outdoor oven / Effeuno)',
      bakeTime: '3–4 minutes',
      bakeTempHome: '250°C max — Baking Steel, top rack, 45 min preheat',
    ...
    steps: [
      'Dissolve yeast in all cold water. Add 1/3 of the {FLOUR} ({W}) and mix to a smooth batter with a spoon.',
      'Add another 1/3 of flour and mix. Add salt and stir in. Add remaining flour and knead by hand 2 min until a rough dough forms.',
      'Gradually work in 6% olive oil while kneading — dough will go sticky then smooth as oil absorbs.',
      'Shape into a ball. Cover with the bowl on the bench and rest 15 min. Re-ball and rest covered 10 min more.',
      'Divide into 175g balls. Place in individual oiled containers. Cold ferment in fridge (5°C) for 24–40 hours.',
      'Remove from fridge. Proof at room temp (20–22°C) for 6–8 hours until relaxed and pillowy.',
      'Dust work surface generously. Flatten ball lightly by hand then roll with a rolling pin from center outwards until wafer-thin (28–30 cm). Use enough flour to prevent sticking.',
      'Top with minimal sauce (1–1.5 tbsp max — too much makes it soggy). Slide into preheated oven at 300°C+ and bake 3–4 min until edges are golden brown.',
    ],
  },
  {
    id: 'detroit',
  ...
  },
  {
    ...
    minOvenTemp: 220, minWStrength: 150,
    timings: {
      bulkRT: '1–2 hours @ 21–25°C (until doubled)',
      bulkCold: '0 hours',
      ballRT: '30 min proof in pan + 20 min proof with toppings',
      ballCold: '0 hours',
      bakeTemp: '250–270°C (outdoor or home oven)',
      bakeTime: '18–20 minutes',
      bakeTempHome: '250–270°C — home oven works perfectly for Sfincione',
      bakeTimeHome: '18–20 min',
      homeNote: 'Sicilian pizza bakes at low temperature — this is one style that actually prefers a home oven. 250°C is ideal.',
    },
    steps: [
      'Make the sauce first so it cools: fry thinly sliced onions in water until soft, then in olive oil until mushy. Add crushed San Marzano tomatoes, salt, oregano, pepper. Simmer 15 min covered. Cool completely.',
      'Mix 78% {FLOUR} ({W}) + 22% fine semolina with sugar and yeast. Add water in thirds, kneading between each addition.',
      'Add salt with the last portion of water. Knead a few minutes. Add olive oil and knead until incorporated.',
      'Knead on the work surface 5 min. Shape into a ball. Cover and rest 10 min. Re-shape until smooth.',
      'Place in a lightly oiled pizza pan (28×25 cm). Cover with cling film. Proof in a warm spot (21–25°C) for 1–2 hours until doubled.',
      'Press dough flat to cover the pan (use a rolling pin if needed). Optionally press anchovy pieces into the dough. Cover and proof 30 min more.',
      'Toast 15g breadcrumbs in olive oil until lightly golden. Set aside.',
      'Spread cooled tomato-onion sauce over the dough. Add caciocavallo (or provolone), breadcrumbs, and a drizzle of olive oil. Proof 20 min more.',
      'Bake at 250–270°C for 18–20 min. Rest 5 min in the pan before slicing.',
    ],
  },
  {
    id: 'chicago',
    ...
    shortName: 'Chicago',
    badge: 'DEEP DISH',
    description: 'Authentic Chicago deep dish from Stadler Made. Low-hydration laminated dough with corn oil creates biscuit-like flaky layers. Cheese first, then meat, then sauce on top.',
    hydration: 40,
    saltPercent: 1.5,
    yeastPercent: 0.5,
    oilPercent: 9,
    sugarPercent: 0.5,
    ballWeight: 305,
    portionType: 'slab', portionLabel: 'pan (9-inch)', portionLabelPlural: 'pans',
    yeastType: 'dry',
    minOvenTemp: 200, minWStrength: 150,
    timings: {
      bulkRT: '5–6 hours @ warm room temp',
      bulkCold: '0 hours',
      ballRT: 'Laminate + 35 min rest + 1 hour final rest',
      ballCold: '0 hours',
      bakeTemp: '220°C (home or outdoor oven)',
      bakeTime: '30–40 minutes',
      bakeTempHome: '220°C — home oven is ideal for Chicago deep dish',
      bakeTimeHome: '30–40 min',
      homeNote: 'Chicago deep dish bakes slow at 220°C — this is one of the few styles where a home oven is the intended tool. No high heat needed.',
    },
    steps: [
      'Mix 85% {FLOUR} ({W}) + 15% fine semolina with sugar, yeast, corn oil, and melted butter. Add all water and knead 5 min.',
      'Add salt and knead another 5 min. Rest 5 min covered. Final knead 2 min. Shape into a ball in an oiled bowl.',
      'Rise in a warm spot for 5–6 hours until doubled.',
      'Laminate: roll dough into a large circle (~0.5cm thick). Fold in half, then fold again into a triangle. Cover and rest 30 min at room temp.',
      'Reshape into a ball. Rest 1 hour at room temp. Dough will be stiff — this is correct.',
      'Preheat oven to 220°C (30 min). Grease a 9-inch (22 cm) deep pan with butter, then dust with grated parmesan for an extra-crispy crust.',
      'Roll dough large enough to line the pan bottom and sides. Press firmly into the edges.',
      'Layer: 200g sliced mozzarella first (all the way to edges), then meat, then spread cooked tomato sauce on top. Finish with grated parmesan.',
      'Bake at 220°C for 30–40 min until crust is golden and sauce is bubbling. Rest 5 min before cutting.',
    ],
  },
  {
    id: 'flammkuchen',
  ...
  },
  {
    ...
    shortName: 'Focaccia',
    badge: 'FOCACCIA',
    description: 'Classic Focaccia Genovese from Stadler Made. 57% hydration + 6% oil, W280 flour, 10–12h cold ferment. Soft inside, crispy bottom, topped with olive oil brine pressed into deep finger dimples.',
    hydration: 57,
    saltPercent: 1.36,
    yeastPercent: 0.45,
    oilPercent: 5.9,
    ...
    timings: {
      ...
      ballRT: '1 hour proof in pan @ 22–25°C + 40 min after salamoia',
      ballCold: '0 hours',
      bakeTemp: '230°C (middle rack)',
      bakeTime: '12–15 minutes',
      bakeTempHome: '230°C (middle rack, conventional oven)',
      bakeTimeHome: '12–15 minutes',
    },
    steps: [
      'Dissolve fresh yeast (and optional diastatic malt powder) in all water. Add 1/3 of {FLOUR} ({W}) and mix to a smooth batter.',
      'Add another 1/3 of flour and knead. Add salt, continue kneading 1 min. Add remaining flour and knead into a rough ball.',
      'Turn out onto counter. Knead a few minutes until smoother. Gradually work in 5.9% olive oil (and optional lard). Cover and rest 20 min.',
      'Shape into a smooth ball. Transfer to a well-oiled container, cover. Rest 40 min at room temp, then refrigerate at 4°C for 10–12 hours.',
      'Remove cold dough. Use a rolling pin to shape it to the size of your oiled 28×25 cm pan while still cold. Place in pan and press into corners. Cover with a damp cloth.',
      'If dough springs back, rest 10 min covered, then rework into corners. Proof in a warm spot (22–25°C) for 1 hour.',
      'Make salamoia: shake 30g warm water + 15g olive oil + pinch of salt in a bottle 15–20 sec. Press finger dents deep into dough across the full surface. Pour salamoia over, covering all holes. Proof 40 min more.',
      'Bake at 230°C (middle rack) for 12–15 min until golden brown. Let cool briefly in pan before slicing.',
    ],
  },
];
