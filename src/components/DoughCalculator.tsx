...
export const PIZZA_PRESETS: PizzaPreset[] = [
  ...
  },
  {
    ...
    timings: {
      ...
      bakeTempHome: '250°C max — Baking Steel, top rack, 1h preheat',
      bakeTimeHome: '7–10 min',
      homeNote: 'Tokyo Style needs high heat for its charred, airy crust. At 250°C expect a fully cooked lighter char — still excellent with the Japanese toppings.',
    },
    steps: [
